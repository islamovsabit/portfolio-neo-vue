    ...
    created() {
        ...
        fetch("https://portfoliobilmer.pythonanywhere.com/api/v5/portfolio-data/")
            ...
            .then(data => {
                ...
                this.displayedData = data.slice(0, this.itemsPerPage);
                console.log(data);
            })
            .catch(error => {
    ...
    methods: {
        ...
        filterData(category) {
            ...
            if (category === 'all') {
                ...
                this.filteredData = this.portfolioData.filter(item => item.portfolio_category_slug.slug === category);
...
<template>
        ...
        <div class="container-main">
            <div class="portfolio-content">
                <div class="portfolio-content-left">
                    <h2 class="portfolio-content-left-title">My All Portfolio Work</h2>
                    <p class="portfolio-content-left-text">
                        Themesberg is an experienced and passionate group of designers, developers,
                        project managers, writers and artists. Every client we work with becomes a
                        part of the team. Together we face the challenges and celebrate the victories.
                    </p>
                    <div class="portfolio-content-left-btn-group">
                        <button type="" class="portfolio-content-left-btn">Download</button>
                        <button type="" class="portfolio-content-left-btn">Contact</button>
                    </div>
                </div>
                <div class="portfolio-content-right">
                    <div class="portfolio-content-right-logo-blog">
                        <img src="../assets/img/neo.webp" class="portfolio-content-right-logo-blog-image" alt="">
                    </div>
                    <div class="portfolio-content-right-index"></div>
                </div>
            </div>
        </div>
    </main>
    <section class="portfolio-rectangle">
        <div class="container-main">
            <div class="portfolio-rectangle-content">
                <div class="portfolio-rectangle-content-blog">
    ...
    <section class="portfolio-regeneration">
        <div class="container-main">
            <div class="portfolio-regeneration-content">
                <div class="portfolio-regeneration-content-category">
                    <h6 class="portfolio-regeneration-content-category-title">Categories</h6>
                    <ul class="portfolio-regeneration-content-category-list">
                        <li class="portfolio-regeneration-content-category-item">
                            <button type="" class="portfolio-regeneration-content-category-item-btn"
                                @click="filterData('all')" :class="{ active: activeCategory === 'all' }"
                                :disabled="activeCategory === 'all'">all</button>
                        </li>
                        <li class="portfolio-regeneration-content-category-item">
                            <button type="" class="portfolio-regeneration-content-category-item-btn"
                                @click="filterData('website')" :class="{ active: activeCategory === 'website' }"
                                :disabled="activeCategory === 'website'">website</button>
                        </li>
                        <li class="portfolio-regeneration-content-category-item">
                            <button type="" class="portfolio-regeneration-content-category-item-btn"
                                @click="filterData('web-design')" :class="{ active: activeCategory === 'web-design' }"
                                :disabled="activeCategory === 'web-design'">web design</button>
                        </li>
                        <li class="portfolio-regeneration-content-category-item">
                            <button type="" class="portfolio-regeneration-content-category-item-btn"
                                @click="filterData('app-design')" :class="{ active: activeCategory === 'app-design' }"
                                :disabled="activeCategory === 'app-design'">app design</button>
                        </li>
                        <li class="portfolio-regeneration-content-category-item">
                            <button type="" class="portfolio-regeneration-content-category-item-btn"
                                @click="filterData('api')" :class="{ active: activeCategory === 'api' }"
                                :disabled="activeCategory === 'api'">api</button>
                        </li>
                        <li class="portfolio-regeneration-content-category-item">
                            <button type="" class="portfolio-regeneration-content-category-item-btn"
                                @click="filterData('telegram-bot')" :class="{ active: activeCategory === 'telegram-bot' }"
                                :disabled="activeCategory === 'telegram-bot'">telegram bot</button>
                        </li>
                    </ul>
                </div>
                <div class="portfolio-regeneration-content-blog-handler">
                    <div class="portfolio-component-content-portfolio">
                        <div class="home-component-content-portfolio-element" v-for="item in displayedData" :key="item.id"
                            ...
                            <div class="home-component-content-portfolio-element-load-more">
                                <a class="home-component-content-portfolio-element-load-more-link"
                                    :href="item.portfolio_link" target="_blank">Learn More</a>
                                <Icon icon="mingcute:snow-fill"
                                    class="home-component-content-portfolio-element-snow-icon" />
                            </div>
                        </div>
                    </div>
                </div>
                <div class="portfolio-regeneration-content-pagination">
                    <button 
                        class="portfolio-regeneration-content-pagination-btn"
                        @click="previousPage"
                        :disabled="currentPage === 1"
                    >Previous</button>
                    <span class="portfolio-regeneration-content-pagination-span-count">{{ currentPage }}&nbsp;/&nbsp;{{
                        totalPages }}</span>
                    <button 
                        class="portfolio-regeneration-content-pagination-btn" 
                        @click="nextPage"
